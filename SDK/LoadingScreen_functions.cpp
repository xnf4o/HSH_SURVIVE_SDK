...
void ULoadingScreen_C::PreConstruct(bool IsDesignTime)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function LoadingScreen.LoadingScreen_C.PreConstruct");
...
void ULoadingScreen_C::ExecuteUbergraph_LoadingScreen(int EntryPoint)
{
	...
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function LoadingScreen.LoadingScreen_C.ExecuteUbergraph_LoadingScreen");
