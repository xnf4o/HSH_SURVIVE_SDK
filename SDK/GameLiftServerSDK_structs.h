...
struct FAWSPlayerSessionServer
{
	...
	unsigned char                                      UnknownData_T3HK[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ON0P[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKeyAndValue
{
	...
	unsigned char                                      UnknownData_1IJ5[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FAttributeValueServer
{
	...
	unsigned char                                      UnknownData_NPC0[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MQAB[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FRegionAndLatency
{
	...
	unsigned char                                      UnknownData_DD43[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FAWSGameSessionServer
{
	...
	unsigned char                                      UnknownData_2LCO[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9H09[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FUpdateGameSessionServer
{
	...
	unsigned char                                      UnknownData_Z4MX[0x7];                                     // 0x00A1(0x0007) MISSED OFFSET (PADDING)
...
struct FDescribePlayerSessionsRequestServer
{
	...
	unsigned char                                      UnknownData_848D[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
