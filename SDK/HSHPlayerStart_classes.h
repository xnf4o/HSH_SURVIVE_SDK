...
// BlueprintGeneratedClass HSHPlayerStart.HSHPlayerStart_C
...
public:
	...
	class UCapsuleComponent*                           Capsule;                                                   // 0x0350(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass HSHPlayerStart.HSHPlayerStart_C");
		return ptr;
	}
