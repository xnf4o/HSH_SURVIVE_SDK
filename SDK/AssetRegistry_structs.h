...
struct FARFilter
{
	...
	unsigned char                                      UnknownData_PO7W[0x50];                                    // 0x0040(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EEQE[0x5];                                     // 0x00E3(0x0005) MISSED OFFSET (PADDING)
...
struct FAssetData
{
	...
	unsigned char                                      UnknownData_UHR0[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
