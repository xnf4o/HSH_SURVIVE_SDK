...
// BlueprintGeneratedClass MechanicSurvivor.MechanicSurvivor_C
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass MechanicSurvivor.MechanicSurvivor_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_MechanicSurvivor(int EntryPoint);
