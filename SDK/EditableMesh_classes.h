...
public:
	...
	unsigned char                                      UnknownData_6J1M[0x9C];                                    // 0x0044(0x009C) MISSED OFFSET (PADDING)
...
// 0x0650 (FullSize[0x0680] - InheritedSize[0x0030])
class UEditableMesh : public UObject
{
public:
	unsigned char                                      UnknownData_7RC2[0x300];                                   // 0x0030(0x0300) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UEditableMeshAdapter*>                Adapters;                                                  // 0x0330(0x0010) (ZeroConstructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_Z61S[0x8];                                     // 0x0340(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                TextureCoordinateCount;                                    // 0x0348(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_BF7N[0x148];                                   // 0x034C(0x0148) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                PendingCompactCounter;                                     // 0x0494(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int                                                SubdivisionCount;                                          // 0x0498(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_AESK[0x1E4];                                   // 0x049C(0x01E4) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_X758[0xA4];                                    // 0x0044(0x00A4) MISSED OFFSET (PADDING)
