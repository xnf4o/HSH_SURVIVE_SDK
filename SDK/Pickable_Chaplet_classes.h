...
// BlueprintGeneratedClass Pickable_Chaplet.Pickable_Chaplet_C
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass Pickable_Chaplet.Pickable_Chaplet_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Pickable_Chaplet(int EntryPoint);
};
