...
// BlueprintGeneratedClass ProjectilePrayAttack.ProjectilePrayAttack_C
// 0x0023 (FullSize[0x0448] - InheritedSize[0x0425])
class AProjectilePrayAttack_C : public AProjectileBase_C
{
public:
	unsigned char                                      UnknownData_1FAO[0x3];                                     // 0x0425(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KNNF[0x3];                                     // 0x0441(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass ProjectilePrayAttack.ProjectilePrayAttack_C");
		return ptr;
	}
	...
	void OnHitConstruct();
	void ExecuteUbergraph_ProjectilePrayAttack(int EntryPoint);
};
