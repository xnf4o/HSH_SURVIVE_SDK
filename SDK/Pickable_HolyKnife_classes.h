...
// BlueprintGeneratedClass Pickable_HolyKnife.Pickable_HolyKnife_C
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass Pickable_HolyKnife.Pickable_HolyKnife_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Pickable_HolyKnife(int EntryPoint);
};
