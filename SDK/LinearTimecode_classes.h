...
public:
	...
	unsigned char                                      UnknownData_JOUA[0x4];                                     // 0x027C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_48MP[0x30];                                    // 0x0290(0x0030) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class LinearTimecode.LinearTimecodeComponent");
		return ptr;
	}
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class LinearTimecode.DropTimecodeToStringConversion");
		return ptr;
	}
