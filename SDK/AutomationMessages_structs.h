...
{
	unsigned char                                      UnknownData_XG3H[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_NV56[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Y6R3[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_NC1K[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FAutomationWorkerFindWorkersResponse
{
	...
	unsigned char                                      UnknownData_SJVA[0x4];                                     // 0x0074(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAutomationWorkerFindWorkers
{
	...
	unsigned char                                      UnknownData_MQXV[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAutomationScreenshotMetadata
{
	...
	unsigned char                                      UnknownData_3B93[0x7];                                     // 0x0089(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RGX7[0x1];                                     // 0x0107(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OHIL[0x6];                                     // 0x0112(0x0006) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_UT7H[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FAutomationWorkerRunTestsReply
{
	...
	unsigned char                                      UnknownData_0HEU[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FAutomationWorkerRunTests
{
	...
	unsigned char                                      UnknownData_GCII[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
struct FAutomationWorkerPerformanceDataResponse
{
	...
	unsigned char                                      UnknownData_SEL3[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAutomationWorkerTestDataResponse
{
	...
	unsigned char                                      UnknownData_IC9T[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FAutomationWorkerImageComparisonResults
{
	...
	unsigned char                                      UnknownData_0P8R[0x6];                                     // 0x0012(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAutomationWorkerSingleTestReply
{
	...
	unsigned char                                      UnknownData_VI1P[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAutomationWorkerRequestTests
{
	...
	unsigned char                                      UnknownData_5A4I[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_PIIR[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
