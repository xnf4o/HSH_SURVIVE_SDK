...
// BlueprintGeneratedClass VanzSurvivor.VanzSurvivor_C
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass VanzSurvivor.VanzSurvivor_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_VanzSurvivor(int EntryPoint);
