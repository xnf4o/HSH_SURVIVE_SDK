...
// BlueprintGeneratedClass StudentFSurvivor.StudentFSurvivor_C
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass StudentFSurvivor.StudentFSurvivor_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_StudentFSurvivor(int EntryPoint);
