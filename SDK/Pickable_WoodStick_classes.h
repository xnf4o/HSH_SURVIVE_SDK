...
// BlueprintGeneratedClass Pickable_WoodStick.Pickable_WoodStick_C
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass Pickable_WoodStick.Pickable_WoodStick_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Pickable_WoodStick(int EntryPoint);
};
