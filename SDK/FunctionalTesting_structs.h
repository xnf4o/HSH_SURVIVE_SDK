...
struct FAutomationScreenshotOptions
{
	...
	unsigned char                                      UnknownData_5R5V[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HZ4Q[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0N0H[0x1];                                     // 0x002F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7HNW[0x6];                                     // 0x003A(0x0006) MISSED OFFSET (PADDING)
...
struct FAITestSpawnInfo
{
	...
	unsigned char                                      UnknownData_2JA2[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E72B[0xC];                                     // 0x0034(0x000C) MISSED OFFSET (PADDING)
...
struct FAITestSpawnSet
{
	...
	unsigned char                                      UnknownData_4WFB[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_8XHN[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (PADDING)
...
struct FTraceQueryTestResultsInnerMost
{
	...
	unsigned char                                      UnknownData_9LZX[0x7];                                     // 0x00A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E098[0x7];                                     // 0x00C9(0x0007) MISSED OFFSET (PADDING)
