...
// BlueprintGeneratedClass Pickable_Medkit.Pickable_Medkit_C
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass Pickable_Medkit.Pickable_Medkit_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Pickable_Medkit(int EntryPoint);
};
