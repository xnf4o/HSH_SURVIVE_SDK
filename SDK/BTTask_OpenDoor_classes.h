...
// BlueprintGeneratedClass BTTask_OpenDoor.BTTask_OpenDoor_C
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass BTTask_OpenDoor.BTTask_OpenDoor_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BTTask_OpenDoor(int EntryPoint);
};
