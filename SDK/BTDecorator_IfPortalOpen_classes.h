...
// BlueprintGeneratedClass BTDecorator_IfPortalOpen.BTDecorator_IfPortalOpen_C
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass BTDecorator_IfPortalOpen.BTDecorator_IfPortalOpen_C");
		return ptr;
	}
