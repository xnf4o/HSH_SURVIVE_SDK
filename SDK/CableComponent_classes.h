...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class CableComponent.CableActor");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_0RKH[0x6];                                     // 0x05A2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6RKQ[0x2];                                     // 0x05E6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6GWR[0x18];                                    // 0x0608(0x0018) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class CableComponent.CableComponent");
		return ptr;
	}
