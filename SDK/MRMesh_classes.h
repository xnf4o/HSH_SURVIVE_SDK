...
public:
	...
	unsigned char                                      UnknownData_R0HC[0x4];                                     // 0x026C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TMUJ[0x4];                                     // 0x02A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MHX9[0x20];                                    // 0x02B0(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_EDH8[0x8];                                     // 0x0578(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_7GDI[0x5];                                     // 0x058B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6WIU[0x28];                                    // 0x05A8(0x0028) MISSED OFFSET (PADDING)
