...
// BlueprintGeneratedClass Pickable_Trap.Pickable_Trap_C
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass Pickable_Trap.Pickable_Trap_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Pickable_Trap(int EntryPoint);
};
