...
// WidgetBlueprintGeneratedClass Fading.Fading_C
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("WidgetBlueprintGeneratedClass Fading.Fading_C");
		return ptr;
	}
	...
	void Construct();
	void RemoveSelf();
	void ExecuteUbergraph_Fading(int EntryPoint);
};
