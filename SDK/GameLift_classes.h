...
{
public:
	unsigned char                                      UnknownData_SBHC[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class GameLift.GameLiftClientObject");
		return ptr;
	}
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class GameLift.GameLiftUtils");
		return ptr;
	}
