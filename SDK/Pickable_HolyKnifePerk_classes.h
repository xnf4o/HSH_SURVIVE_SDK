...
// BlueprintGeneratedClass Pickable_HolyKnifePerk.Pickable_HolyKnifePerk_C
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass Pickable_HolyKnifePerk.Pickable_HolyKnifePerk_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Pickable_HolyKnifePerk(int EntryPoint);
};
