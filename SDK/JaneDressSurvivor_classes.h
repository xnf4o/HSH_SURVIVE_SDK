...
// BlueprintGeneratedClass JaneDressSurvivor.JaneDressSurvivor_C
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass JaneDressSurvivor.JaneDressSurvivor_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_JaneDressSurvivor(int EntryPoint);
