...
// BlueprintGeneratedClass Pickable_WeaponBase.Pickable_WeaponBase_C
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass Pickable_WeaponBase.Pickable_WeaponBase_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Pickable_WeaponBase(int EntryPoint);
};
