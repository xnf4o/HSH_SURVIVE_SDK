...
// BlueprintGeneratedClass HolyKnifePerkActor.HolyKnifePerkActor_C
...
public:
	...
	class UParticleSystemComponent*                    P_TimPerk;                                                 // 0x0348(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass HolyKnifePerkActor.HolyKnifePerkActor_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_HolyKnifePerkActor(int EntryPoint);
};
