...
{
public:
	unsigned char                                      UnknownData_AEPH[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IN23[0x10];                                    // 0x0058(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	class UGeometryCacheComponent*                     GeometryCacheComponent;                                    // 0x0338(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	TArray<int>                                        TopologyRanges;                                            // 0x0030(0x0010) (Edit, ZeroConstructor, EditConst, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	unsigned char                                      UnknownData_473O[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OEL3[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_GBMZ[0x2];                                     // 0x05AA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J21O[0x30];                                    // 0x05BC(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZI85[0xF];                                     // 0x05F1(0x000F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_US1G[0x2C];                                    // 0x0034(0x002C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_5U26[0x24];                                    // 0x0064(0x0024) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_DDIW[0x128];                                   // 0x0068(0x0128) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              StartSampleTime;                                           // 0x0190(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_TD91[0x4];                                     // 0x0194(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_W4V9[0xA8];                                    // 0x0060(0x00A8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_X9CH[0xA8];                                    // 0x0060(0x00A8) MISSED OFFSET (PADDING)
