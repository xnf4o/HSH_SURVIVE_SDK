...
struct UBTTask_TryOpenPortal_C_ReceiveExecuteAI_Params
{
...
struct UBTTask_TryOpenPortal_C_OnFinishOpenPortalEvent_Params
{
};

// Function BTTask_TryOpenPortal.BTTask_TryOpenPortal_C.ReceiveTickAI
struct UBTTask_TryOpenPortal_C_ReceiveTickAI_Params
{
	class AAIController*                               OwnerController;                                           // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class APawn*                                       ControlledPawn;                                            // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UBTTask_TryOpenPortal_C_ExecuteUbergraph_BTTask_TryOpenPortal_Params
{
