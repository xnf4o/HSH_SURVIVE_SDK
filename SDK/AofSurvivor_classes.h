...
// BlueprintGeneratedClass AofSurvivor.AofSurvivor_C
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass AofSurvivor.AofSurvivor_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AofSurvivor(int EntryPoint);
