...
// BlueprintGeneratedClass ProjectileHolyWater.ProjectileHolyWater_C
// 0x001B (FullSize[0x0440] - InheritedSize[0x0425])
class AProjectileHolyWater_C : public AProjectileBase_C
{
public:
	unsigned char                                      UnknownData_IH2D[0x3];                                     // 0x0425(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass ProjectileHolyWater.ProjectileHolyWater_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_ProjectileHolyWater(int EntryPoint);
};
