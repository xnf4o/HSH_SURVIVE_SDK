...
// BlueprintGeneratedClass DummySurvivor.DummySurvivor_C
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass DummySurvivor.DummySurvivor_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_DummySurvivor(int EntryPoint);
