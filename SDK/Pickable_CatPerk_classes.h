...
// BlueprintGeneratedClass Pickable_CatPerk.Pickable_CatPerk_C
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass Pickable_CatPerk.Pickable_CatPerk_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Pickable_CatPerk(int EntryPoint);
};
