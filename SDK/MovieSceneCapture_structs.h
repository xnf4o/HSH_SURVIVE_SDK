...
struct FMovieSceneCaptureSettings
{
	...
	unsigned char                                      UnknownData_VEIN[0x2];                                     // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_52OP[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_4K1B[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
