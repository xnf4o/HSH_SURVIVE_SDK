...
{
	unsigned char                                      UnknownData_AMVR[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_N09V[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FRecordedFrame
{
	...
	unsigned char                                      UnknownData_RG3V[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
