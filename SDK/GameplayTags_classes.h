...
public:
	...
	unsigned char                                      UnknownData_38ZL[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_A5GA[0x170];                                   // 0x0030(0x0170) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FGameplayTagSource>                  TagSources;                                                // 0x01A0(0x0010) (ZeroConstructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_W9X2[0x78];                                    // 0x01B0(0x0078) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UDataTable*>                          GameplayTagTables;                                         // 0x0228(0x0010) (ZeroConstructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_OT4X[0x50];                                    // 0x0238(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_RV4X[0x5];                                     // 0x0053(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TArray<struct FName>                               CommonlyReplicatedTags;                                    // 0x0098(0x0010) (Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
