...
struct FImageWriteOptions
{
	...
	unsigned char                                      UnknownData_2UFM[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QQRE[0x56];                                    // 0x001A(0x0056) MISSED OFFSET (PADDING)
