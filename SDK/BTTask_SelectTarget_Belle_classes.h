...
// BlueprintGeneratedClass BTTask_SelectTarget_Belle.BTTask_SelectTarget_Belle_C
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass BTTask_SelectTarget_Belle.BTTask_SelectTarget_Belle_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BTTask_SelectTarget_Belle(int EntryPoint);
};
