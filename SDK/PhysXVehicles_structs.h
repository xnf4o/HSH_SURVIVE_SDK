...
struct FVehicleEngineData
{
	...
	unsigned char                                      UnknownData_ZZQV[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
...
struct FVehicleDifferential4WData
{
	...
	unsigned char                                      UnknownData_XR80[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWheelSetup
{
	...
	unsigned char                                      UnknownData_IK1H[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FTireConfigMaterialFriction
{
	...
	unsigned char                                      UnknownData_N16V[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FVehicleTransmissionData
{
	...
	unsigned char                                      UnknownData_CGEJ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TOPP[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_B3QH[0x18];                                    // 0x00C8(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_NG27[0x10];                                    // 0x0710(0x0010) MISSED OFFSET (PADDING)
