...
{
	unsigned char                                      UnknownData_I33I[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEngineServicePong
{
	...
	unsigned char                                      UnknownData_LILV[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R76L[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
