...
// BlueprintGeneratedClass Pickable_Nail.Pickable_Nail_C
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass Pickable_Nail.Pickable_Nail_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Pickable_Nail(int EntryPoint);
};
