...
{
public:
	unsigned char                                      UnknownData_3K26[0x20];                                    // 0x0030(0x0020) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class MobilePatchingUtils.MobileInstalledContent");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_OFYM[0x40];                                    // 0x0050(0x0040) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class MobilePatchingUtils.MobilePendingContent");
		return ptr;
	}
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class MobilePatchingUtils.MobilePatchingLibrary");
		return ptr;
	}
