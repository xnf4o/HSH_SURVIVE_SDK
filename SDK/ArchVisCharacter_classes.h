...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class ArchVisCharacter.ArchVisCharacter");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_I3GT[0x18];                                    // 0x0778(0x0018) MISSED OFFSET (PADDING)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("Class ArchVisCharacter.ArchVisCharMovementComponent");
		return ptr;
	}
