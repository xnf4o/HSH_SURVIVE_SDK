...
// BlueprintGeneratedClass CraneBase.CraneBase_C
// 0x004F (FullSize[0x0718] - InheritedSize[0x06C9])
class ACraneBase_C : public AInteractionBase_C
{
public:
	unsigned char                                      UnknownData_P5U5[0x7];                                     // 0x06C9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OFE6[0x2];                                     // 0x06FA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              Cooldown;                                                  // 0x06FC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ACraneObject_C*                              CraneObject;                                               // 0x0700(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                               bIsCraneBusy;                                              // 0x0708(0x0001) (Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_0ISL[0x7];                                     // 0x0709(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class ULevelSequence*                              LevelSequence;                                             // 0x0710(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass CraneBase.CraneBase_C");
		return ptr;
	}
	...
	void OnServerSwitchChange(class AHSHCharacterBase* Character);
	void ReceiveBeginPlay();
	void ShowIndicator(class AActor* PlayerCharacter);
	void ExecuteUbergraph_CraneBase(int EntryPoint);
};
