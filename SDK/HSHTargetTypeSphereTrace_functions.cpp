...
// Function HSHTargetTypeSphereTrace.HSHTargetTypeSphereTrace_C.GetTargets
...
void UHSHTargetTypeSphereTrace_C::GetTargets(class AHSHCharacterBase* TargetingCharacter, class AActor* TargetingActor, const struct FGameplayEventData& EventData, TArray<struct FHitResult>* OutHitResults, TArray<class AActor*>* OutActors)
{
	static auto fn = nullptr;
	if (!fn)
		fn = 
UObject::FindObject<UFunction>("Function HSHTargetTypeSphereTrace.HSHTargetTypeSphereTrace_C.GetTargets");

	UHSHTargetTypeSphereTrace_C_GetTargets_Params params;
