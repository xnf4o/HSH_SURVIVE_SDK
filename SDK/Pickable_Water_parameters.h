...
struct APickable_Water_C_Interaction_Params
{
	class AHSHCharacterBase*                           Character;                                                 // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function Pickable_Water.Pickable_Water_C.SetCollisionResponseInteract
struct APickable_Water_C_SetCollisionResponseInteract_Params
{
...
struct APickable_Water_C_ExecuteUbergraph_Pickable_Water_Params
{
