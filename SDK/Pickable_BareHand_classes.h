...
// BlueprintGeneratedClass Pickable_BareHand.Pickable_BareHand_C
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass Pickable_BareHand.Pickable_BareHand_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Pickable_BareHand(int EntryPoint);
};
