...
struct FAnimationSetup
{
	...
	unsigned char                                      UnknownData_83U9[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimationStateEntry
{
	...
	unsigned char                                      UnknownData_XYXP[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WR0W[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2YYF[0x1];                                     // 0x0023(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_82JV[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimationSharingScalability
{
	...
	unsigned char                                      UnknownData_MR36[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_AY25[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
