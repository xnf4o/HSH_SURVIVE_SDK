...
// BlueprintGeneratedClass SecuritySurvivor.SecuritySurvivor_C
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass SecuritySurvivor.SecuritySurvivor_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_SecuritySurvivor(int EntryPoint);
