...
// BlueprintGeneratedClass BTTask_StopAI.BTTask_StopAI_C
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass BTTask_StopAI.BTTask_StopAI_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BTTask_StopAI(int EntryPoint);
};
