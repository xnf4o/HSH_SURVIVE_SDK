...
// BlueprintGeneratedClass TimSurvivor.TimSurvivor_C
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass TimSurvivor.TimSurvivor_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_TimSurvivor(int EntryPoint);
