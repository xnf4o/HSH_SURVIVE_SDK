...
{
public:
	unsigned char                                      UnknownData_PTDK[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UTN9[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (PADDING)
