...
// BlueprintGeneratedClass Pickable_MagicRice.Pickable_MagicRice_C
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("BlueprintGeneratedClass Pickable_MagicRice.Pickable_MagicRice_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Pickable_MagicRice(int EntryPoint);
};
