...
// WidgetBlueprintGeneratedClass Ingame_NotifyText.Ingame_NotifyText_C
...
public:
	...
	if (!ptr)
		ptr = 
UObject::FindClass("WidgetBlueprintGeneratedClass Ingame_NotifyText.Ingame_NotifyText_C");
		return ptr;
	}



	void BeginNotify(const struct FText& Text, float PlayRate);
	void ExecuteUbergraph_Ingame_NotifyText(int EntryPoint);
};
