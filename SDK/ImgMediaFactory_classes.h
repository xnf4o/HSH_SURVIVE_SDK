...
public:
	...
	unsigned char                                      UnknownData_26KY[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HC26[0x7];                                     // 0x0061(0x0007) MISSED OFFSET (PADDING)
